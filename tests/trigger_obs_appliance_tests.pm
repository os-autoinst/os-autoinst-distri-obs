...
sub run() {
	...
	assert_script_run("cd ~ ; git clone --single-branch --branch fix_tests_for_openQA --depth 1 https://github.com/M0ses/open-build-service.git  /tmp/open-build-service", 200);
